<div x-data="{ open: @entangle('show') }">
    ...
    <div x-show="open" x-cloak class="absolute inset-0 bg-opacity-80 bg-black">
        <div  class="absolute inset-8 rounded-lg border-black border-8 bg-slate-300 p-4 flex">
            ...
            <img src="{{ $this->most_recent_card->faces->first()->png_uri ?? 'https://static.wikia.nocookie.net/mtgsalvation_gamepedia/images/f/f8/Magic_card_back.jpg/revision/latest?cb=20140813141013' }}" alt="{{ $this->most_recent_card->name }}" class="h-full"/>
            <ul class="m-4 grow">
